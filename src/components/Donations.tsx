                    ...
                    {isAdmin && (
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                        <div className="flex justify-center gap-3">
                          ...
                          <button onClick={() => duplicateDonation(donation.id)} className="text-green-600 hover:text-green-900" title={t.duplicate}>
                          ...
                          <button 
                            onClick={() => {
                              if(window.confirm(t.areYouSureDelete)) deleteDonation(donation.id);
                            }} 
